        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="videoid" value="${video != null?video.videoid:''}"
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                    <div class="row">
                    ...
                    <center><h5 class="text-center text-danger" id="message"></h5></center>
                </div>
            </div>
        </section>
        <br/><br/>
...
<script>
    ...
    $('#submitBtn').click(function () {
        ...
        if (isEdit == 'true'){
            url = "/Assignment_java4_thinhlhph19459/admin/video?action=edit&id=" + vidOrigin;
        }else{
            url = "/Assignment_java4_thinhlhph19459/admin/video?action=add";
        }

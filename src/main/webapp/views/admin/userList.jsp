                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td>${items.email}</td>
                            <td>${items.admin?"Admin":"User"}</td>
                            <td>
                                <a type="button" href="<c:url value="/admin/user?action=edit&id=${items.userid}"/>" class="btn btn-block btn-info btn-sm" >Edit</a>
                                <button type="button" onclick="deleteUser('${items.userid}')" class="btn btn-block btn-danger btn-sm" >Delete</button>
                            </td>
                        </tr>
                        </c:forEach>
                        </tbody>
...
<script>
    function deleteUser(userid) {
        $.ajax({
            url: '/Assignment_java4_thinhlhph19459/admin/user?action=delete&id='+userid
        }).then(function (data) {

            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="<c:url value='/util/dist/img/user1-128x128.jpg'/>" alt="User Avatar"
                    ...
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="<c:url value='/util/dist/img/user8-128x128.jpg'/>" alt="User Avatar"
                    ...
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="<c:url value='/util/dist/img/user3-128x128.jpg'/>" alt="User Avatar"
                                 class="img-size-50 img-circle mr-3">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    Nora Silvester
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<c:url value="/admin/report?action=viewFavorite"/>" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Favorites</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href=""<c:url value="/admin/report?action=viewFavorite"/>"" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Favorites User</p>
                                </a>
                            </li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        <thead>
                        <h6 class="fw-bold">Video Title</h6><br>
                        <select id="videotitle" onchange="sendData()" class="custom-select form-control-border" >
                            <option selected>Open this select menu</option>
                            <c:forEach var="items" items="${items}">
                                <option value="${items.group}">${items.group}</option>
                            </c:forEach>
                        </select>
                        <tr>
                            <th>Username</th>
...
<script>
    function sendData() {
        var selectedGroup = $('#videotitle').val();
        $.ajax({
            url: 'http://localhost:8080/Assignment_java4_thinhlhph19459/admin/report?action=showUserlike',
            type: 'POST',
